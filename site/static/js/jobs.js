(function() {
    "use strict";
    var source = $("#jobs-template").html(), template = Handlebars.compile(source), $jobs = $(".job-list"), $loading = $(".spinner");
    // Call the USA Jobs API
    function sendRequest() {
        var baseUrl = "https://data.usajobs.gov/api/jobs", parameters = {
            OrganizationID: "IN15",
            // Get results for USFWS only
            NumberOfJobs: "250",
